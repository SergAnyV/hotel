...
INSERT INTO users (nick_name, first_name, fathers_name, last_name, email, phone, password, created_at, updated_at, role_id) VALUES
...
('cleaner_maria', 'Мария', 'Александровна', 'Смирнова', 'cleaner@hotel.ru', '79164567890', '$2a$10$GjGv9uyQejDku0lPUkTLB.xti8VPuYMWwdx.vmY0mNXvd7TRLmyCi', NOW(), NOW(), 4),
