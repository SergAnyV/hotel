...
public class ServiceHotelSimpleDTO {
    @Schema(description = "название сервиса", example = "Завтрак шведский стол")
    @NotBlank(message = " не должен быть пустым")
    @Size(min = 3,max = 20,message = "количество символов 3-20")
    private String title;

    @Schema(description = "описание сервиса", example = "Богатый выбор блюд на завтрак включительно с напитками")
    @NotBlank(message = " не должен быть пустым")
